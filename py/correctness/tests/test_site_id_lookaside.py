...
def test_insert_site_id():
    ...
    a.execute(
        "INSERT INTO crsql_changes VALUES ('foo', x'010901', 'b', 1, 1, 1, x'1dc8d6bb7f8941088327d9439a7927a4', 1, 0, 1)")
    a.commit()
...
def test_site_id_ordinals_do_not_move_on_merge():
    ...
    a.execute(
        "INSERT INTO crsql_changes VALUES ('foo', x'010902', 'b', 1, 1, 1, x'1dc8d6bb7f8941088327d9439a7927a4', 1, 0, 1)")
    a.commit()
    ...
    a.execute(
        "INSERT INTO crsql_changes VALUES ('foo', x'010903', 'b', 1, 1, 1, x'2dc8d6bb7f8941088327d9439a7927a4', 1, 0, 1)")
    a.commit()
    # insert again with that new site id
    a.execute(
        "INSERT INTO crsql_changes VALUES ('foo', x'010904', 'b', 1, 1, 1, x'2dc8d6bb7f8941088327d9439a7927a4', 1, 0, 1)")
    a.commit()
